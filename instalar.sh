...
until docker exec moodle-app php -r "echo 'OK';" &>/dev/null; do
    ...
    if [ $COUNTER -ge $MAX_RETRIES ]; then
        echo "⚠️  Advertencia: Tiempo de espera superado comprobando PHP en Moodle."
        break
    fi
done
...
echo ""
echo "⚙️  [5/5] Instalando/Actualizando el plugin en la base de datos de Moodle..."
...
echo "    2. Entra a un curso -> haz clic en 'Activar edición'."
echo "    3. Haz clic en 'Añadir un bloque' -> selecciona 'Métricas de Base de Conocimiento Git'."
